...
#define TESTDRV_CONTROL_PADCONF_UART1_TX_OFFSET 0xB3
#define TESTDRV_CONTROL_PADCONF_UART1_RX_OFFSET 0xB4
#define TESTDRV_OMAP24XX_VA_SYSTEM_CONTROL_BASE	IO_ADDRESS(OMAP24XX_SYSTEM_CONTROL_BASE)
#define TESTDRV_GPIO_9                          9
#define TESTDRV_GPIO_10                         10
